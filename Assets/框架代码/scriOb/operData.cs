...
public class operData : ScriptableObject
{
    ...
    [Header("低血量")]
    public List<AudioClip> LowHP = new List<AudioClip>();
    [Header("倒下")]
    public List<AudioClip> DieAudio = new List<AudioClip>();
    [Header("1技能释放")]
    public List<AudioClip> Skill1_Release = new List<AudioClip>();
    [Header("2技能释放")]
    public List<AudioClip> Skill2_Release = new List<AudioClip>();
    [Header("3技能释放")]
    public List<AudioClip> Skill3_Release = new List<AudioClip>();
    [Header("3星结束行动")]
    ...
    [EnumLabel("再部署")]
    public speedDescription resetSpeedDescription;
    ...
    [Header("天赋图标")] 
    public Sprite[] talentImage = new Sprite[2];
...
public enum speedDescription : byte
{
    [EnumLabel("非常慢")]
    verySlow,
    [EnumLabel("较慢")]
