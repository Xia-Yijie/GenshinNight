...
public class OperUIElements : MonoBehaviour
{
    ...
    public GameObject skillStop_p;
    public static GameObject skillStop;
    public AudioSource RetreatAudio_p;
    public static AudioSource RetreatAudio;
    public AudioSource DieAudio_p;
    public static AudioSource DieAudio;
    public AudioSource EnemyInAudio_p;
    public static AudioSource EnemyInAudio;
    ...
    public Text atkDetailText_p;                // 详细数值
    ...
    public List<RectTransform> talentRect_p = new List<RectTransform>();
    public static List<RectTransform> talentRect = new List<RectTransform>();
    public Text talent1_p;                  //天赋部分
    public static Text talent1;
    public Text talent2_p;
    public static Text talent2;
    public Image talen1_Image_p;
    public static Image talen1_Image;
    public Image talent2_Image_p;
    public static Image talent2_Image;
    public Text talent1_NameText_p;
    public static Text talent1_NameText;
    public Text talent2_NameText_p;
    public static Text talent2_NameText;
    ...
    private void Init()
    {
        ...
        skillStop = skillStop_p;
        RetreatAudio = RetreatAudio_p;
        DieAudio = DieAudio_p;
        EnemyInAudio = EnemyInAudio_p;
        ...
        talentRect = talentRect_p;
        talent1 = talent1_p;
        talent2 = talent2_p;
        talen1_Image = talen1_Image_p;
        talent2_Image = talent2_Image_p;
        talent1_NameText = talent1_NameText_p;
        talent2_NameText = talent2_NameText_p;
